    ...
    return (
        <div className='max-w-6xl mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                ...
                <div>
                    <h2 className='font-bold text-gray-800 mb-1'>Category Name & Length</h2>
                    <p className='text-gray-600 text-sm mb-4'>Category Name</p>

                    <div className='space-y-4'>
                        {/** i will use map method */}
                        <div className='bg-white rounded-xl p-6 border-t-4 cursor-pointer
                            ...
                            <span className='inline-block bg-blue-500 text-blue-600
